...
#define LOW_PRECISION`),t}function WA(o){let t="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===cv?t="SHADOWMAP_TYPE_PCF":o.shadowMapType===ax?t="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===ji&&(t="SHADOWMAP_TYPE_VSM"),t}function YA(o){let t="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case vs:case Ss:t="ENVMAP_TYPE_CUBE";break;case Nc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function ZA(o){let t="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Ss:t="ENVMAP_MODE_REFRACTION";break}return t}function KA(o){let t="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case uv:t="ENVMAP_BLENDING_MULTIPLY";break;case Ex:t="ENVMAP_BLENDING_MIX";break;case Tx:t="ENVMAP_BLENDING_ADD";break}return t}function QA(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:r,maxMip:i}}function jA(o,t,i,r){const l=o.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=WA(i),p=YA(i),g=ZA(i),v=KA(i),S=QA(i),y=IA(i),E=FA(c),C=l.createProgram();let M,_,F=i.glslVersion?"#version "+i.glslVersion+`
